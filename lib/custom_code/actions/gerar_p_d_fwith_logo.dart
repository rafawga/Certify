...
Future<String> gerarPDFwithLogo(String svgUrl, String cor) async {
  ...
  try {
    ...
    // URL fixa da imagem para substituir o logo
    final String logoUrl =
        'https://upload.wikimedia.org/wikipedia/commons/4/47/PNG_transparency_demonstration_1.png'; // Exemplo de uma imagem da Wikipedia

    // Substitui o xlink:href da imagem codificada em Base64 pela URL da imagem da web
    svgContent = svgContent.replaceAll(
        RegExp(r'data:image/png;base64,[A-Za-z0-9+/=]+'), logoUrl);
      ...
      pw.Page(
        ...
        build: (pw.Context context) {
          return pw.Center(
            child: pw.SvgImage(
              svg:
                  svgContent, // Renderiza o SVG modificado com a nova imagem da web
            ),
          );
        },
      ),
