...
import 'template_config_copy_model.dart';
export 'template_config_copy_model.dart';

class TemplateConfigCopyWidget extends StatefulWidget {
  const TemplateConfigCopyWidget({
    super.key,
  ...
  @override
  State<TemplateConfigCopyWidget> createState() =>
      _TemplateConfigCopyWidgetState();
}

class _TemplateConfigCopyWidgetState extends State<TemplateConfigCopyWidget>
    with TickerProviderStateMixin {
  late TemplateConfigCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TemplateConfigCopyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<CursosRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final templateConfigCopyCursosRecord = snapshot.data!;
                                                        ...
                                                        children: [
                                                          Row(
                                                            ...
                                                            children: [
                                                              ...
                                                              Text(
                                                                'Editar template de ${templateConfigCopyCursosRecord.name}',
                                                                  ...
                                                                  builder: (context,
                                                                    ...
                                                                    return SizedBox(
                                                                      ...
                                                                      child: CarouselSlider
                                                                          .builder(
                                                                        itemCount:
                                                                            carouselTemplateImagesRecordList.length,
                                                                        itemBuilder: (context,
                                                                            carouselIndex,
                                                                            _) {
                                                                        ...
                                                                        options:
                                                                          ...
                                                                          onPageChanged:
                                                                            ...
                                                                            await rowTemplateRecord!.reference.update(createTemplateRecordData(
                                                                              index: carouselTemplateImagesRecordList.elementAtOrNull(_model.carouselCurrentIndex1)?.index,
                                                                            ));
                                                                          },
                                                                        ),
                                                                      ),
                                                              ...
                                                              FFButtonWidget(
                                                                onPressed:
                                                                  ...
                                                                  _model.pdfReturn2 =
                                                                    ...
                                                                    rowTemplateRecord
                                                                        .isACourse,
                                                                    templateConfigCopyCursosRecord
                                                                        .instructorName,
                                                                    dateTimeFormat(
                                                                      "d/M/y",
                                                                      getCurrentTimestamp,
