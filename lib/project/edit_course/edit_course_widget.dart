                          ...
                          child: Align(
                            ...
                            child: Padding(
                              ...
                              child: StreamBuilder<CursosRecord>(
                                stream:
                                    CursosRecord.getDocument(widget.cursoId!),
                                builder: (context, snapshot) {
                                  ...
                                  final fullWidthCursosRecord = snapshot.data!;
                                                ...
                                                Padding(
                                                  padding: const EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          12.0, 0.0, 0.0, 0.0),
                                                  child: Text(
                                                    'Modifique as informações do seu curso.',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyLarge
                                                        .override(
