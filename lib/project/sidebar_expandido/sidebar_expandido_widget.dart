...
import 'sidebar_expandido_model.dart';
export 'sidebar_expandido_model.dart';

class SidebarExpandidoWidget extends StatefulWidget {
  const SidebarExpandidoWidget({
    super.key,
    int? currentTab,
  ...
  @override
  State<SidebarExpandidoWidget> createState() => _SidebarExpandidoWidgetState();
}

class _SidebarExpandidoWidgetState extends State<SidebarExpandidoWidget> {
  late SidebarExpandidoModel _model;
                ...
                Padding(
                  ...
                  child: AuthUserStreamWidget(
                    builder: (context) => InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        context.pushNamed('user-certificates');
                      },
                      child: Container(
                        width: double.infinity,
                        height: 50.0,
