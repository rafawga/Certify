...
import 'svg_create_new_model.dart';
export 'svg_create_new_model.dart';

class SvgCreateNewWidget extends StatefulWidget {
  const SvgCreateNewWidget({super.key});

  @override
  State<SvgCreateNewWidget> createState() => _SvgCreateNewWidgetState();
}

class _SvgCreateNewWidgetState extends State<SvgCreateNewWidget> {
  late SvgCreateNewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SvgCreateNewModel());

    _model.nomeTextController ??= TextEditingController();
    _model.nomeFocusNode ??= FocusNode();

    _model.fontalunoTextController ??= TextEditingController();
    _model.fontalunoFocusNode ??= FocusNode();

    _model.fonteMainTextTextController ??= TextEditingController();
    _model.fonteMainTextFocusNode ??= FocusNode();
    ...
    _model.nomeAlunoTestTextController ??= TextEditingController();
    _model.nomeAlunoTestFocusNode ??= FocusNode();

    _model.nomeCursoTestTextController ??= TextEditingController();
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
          ...
          _model.nomeCursoTestTextController?.text = 'Master Chef';
        }));
  }
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Text(
                              'Área de criação (configurar parâmetros)',
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            FlutterFlowDropDown<String>(
                              controller: _model.alunoAlignValueController ??=
                                  FormFieldController<String>(
                                _model.alunoAlignValue ??=
                                    Alinhamento.Left.name,
                              ),
                              options: Alinhamento.values
                                  .map((e) => e.name)
                                  .toList(),
                              onChanged: (val) => safeSetState(
                                  () => _model.alunoAlignValue = val),
                              width: 200.0,
                              height: 40.0,
                              textStyle: FlutterFlowTheme.of(context)
                                  .bodyMedium
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            FlutterFlowDropDown<String>(
                              controller:
                                  _model.maintextAlignValueController ??=
                                      FormFieldController<String>(
                              ...
                              hintText: 'alinhamento main text',
                              icon: Icon(
                                Icons.keyboard_arrow_down_rounded,
                                color:
                                    FlutterFlowTheme.of(context).secondaryText,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            SizedBox(
                              width: 200.0,
                              child: TextFormField(
                                controller: _model.fontalunoTextController,
                                focusNode: _model.fontalunoFocusNode,
                                autofocus: false,
                                obscureText: false,
                                decoration: InputDecoration(
                                  isDense: true,
                                ...
                                cursorColor:
                                    FlutterFlowTheme.of(context).primaryText,
                                validator: _model
                                    .fontalunoTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                            FFButtonWidget(
                              onPressed: () async {
                                await actions.generatePDFWithFont(
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            SizedBox(
                              width: 200.0,
                              child: TextFormField(
                                controller: _model.fonteMainTextTextController,
                                focusNode: _model.fonteMainTextFocusNode,
                                autofocus: false,
                                obscureText: false,
                                decoration: InputDecoration(
                                  isDense: true,
                                ...
                                cursorColor:
                                    FlutterFlowTheme.of(context).primaryText,
                                validator: _model
                                    .fonteMainTextTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                            FFButtonWidget(
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            SizedBox(
                              width: 200.0,
                              child: TextFormField(
                                controller: _model.fonteCodeTextController,
                                focusNode: _model.fonteCodeFocusNode,
                                autofocus: false,
                                obscureText: false,
                                decoration: InputDecoration(
                                  isDense: true,
                                ...
                                cursorColor:
                                    FlutterFlowTheme.of(context).primaryText,
                                validator: _model
                                    .fonteCodeTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                            FFButtonWidget(
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                ...
                                if (colorPicked3Color != null) {
                                  safeSetState(() =>
                                      _model.colorPicked3 = colorPicked3Color);
                                }
                              },
                              child: Container(
                                width: 20.0,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            SizedBox(
                              width: 400.0,
                              child: TextFormField(
                                controller: _model.mainTextTextController,
                                focusNode: _model.mainTextFocusNode,
                                autofocus: false,
                                obscureText: false,
                                decoration: InputDecoration(
                                  isDense: true,
                                ...
                                cursorColor:
                                    FlutterFlowTheme.of(context).primaryText,
                                validator: _model
                                    .mainTextTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ],
                          ...
                          children: [
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 0.0, 10.0, 0.0),
                              child: Text(
                                'Possui cores customizadas (detalhes)?',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      fontFamily: 'Readex Pro',
                            ...
                            Theme(
                              ...
                              child: Checkbox(
                                value: _model.hasDetailsValue ??= false,
                                onChanged: (newValue) async {
                                  safeSetState(
                                      () => _model.hasDetailsValue = newValue!);
                                },
                                side: BorderSide(
                                  width: 2,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            SizedBox(
                              width: 200.0,
                              child: TextFormField(
                                controller: _model.nomeAlunoTestTextController,
                                focusNode: _model.nomeAlunoTestFocusNode,
                                autofocus: false,
                                obscureText: false,
                                decoration: InputDecoration(
                                  isDense: true,
                                ...
                                cursorColor:
                                    FlutterFlowTheme.of(context).primaryText,
                                validator: _model
                                    .nomeAlunoTestTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ],
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            SizedBox(
                              width: 200.0,
                              child: TextFormField(
                                controller: _model.nomeCursoTestTextController,
                                focusNode: _model.nomeCursoTestFocusNode,
                                autofocus: false,
                                obscureText: false,
                                decoration: InputDecoration(
                                  isDense: true,
                                ...
                                cursorColor:
                                    FlutterFlowTheme.of(context).primaryText,
                                validator: _model
                                    .nomeCursoTestTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ],
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                ...
                                if (colorPicked4Color != null) {
                                  safeSetState(() =>
                                      _model.colorPicked4 = colorPicked4Color);
                                }
                              },
                              child: Container(
                                width: 20.0,
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                await actions.gerarCertificado(
                                  _model.uploadedFileUrl1,
                                  functions.colorToString(_model.colorPicked4)!,
                                  _model.nomeAlunoTestTextController.text,
                                  true,
                                  'Fernanda Silva',
                                  dateTimeFormat(
                                    "d/M/y",
                                  ...
                                  '12',
                                  _model.nomeCursoTestTextController.text,
                                  '356734deb5c63e23bff9b9bfe7fae4',
                                  true,
                                  ...
                                  true,
                                  true,
                                  functions.colorToString(_model.colorPicked1)!,
                                  functions.colorToString(_model.colorPicked2)!,
                                  functions.colorToString(_model.colorPicked3)!,
                                  _model.fontalunoTextController.text,
                                  _model.fonteMainTextTextController.text,
                                  _model.fonteCodeTextController.text,
                                  _model.alunoAlignValue!,
                              ...
                              onPressed: () async {
                                _model.ultimo =
                                  ...
                                  queryBuilder: (templateImagesRecord) =>
                                      templateImagesRecord.orderBy('Index',
                                          descending: true),
                                  singleRecord: true,
