...
import '/components/empty_cases_widget.dart';
...
import 'user_certificates_model.dart';
export 'user_certificates_model.dart';

class UserCertificatesWidget extends StatefulWidget {
  const UserCertificatesWidget({super.key});

  @override
  State<UserCertificatesWidget> createState() => _UserCertificatesWidgetState();
}

class _UserCertificatesWidgetState extends State<UserCertificatesWidget>
    with TickerProviderStateMixin {
  late UserCertificatesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserCertificatesModel());
                                                  ...
                                                  child: StreamBuilder<
                                                    ...
                                                    builder:
                                                      ...
                                                      List<AlunosCursoRecord>
                                                          ...
                                                          snapshot.data!;
                                                      if (listViewAlunosCursoRecordList
                                                          .isEmpty) {
                                                        return const EmptyCasesWidget(
                                                          text:
                                                              'Você ainda não possui certificações na plataforma Certify :( ',
                                                        );
                                                      }
