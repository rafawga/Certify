...
import 'productor_course_model.dart';
export 'productor_course_model.dart';

class ProductorCourseWidget extends StatefulWidget {
  const ProductorCourseWidget({super.key});

  @override
  State<ProductorCourseWidget> createState() => _ProductorCourseWidgetState();
}

class _ProductorCourseWidgetState extends State<ProductorCourseWidget>
    with TickerProviderStateMixin {
  late ProductorCourseModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProductorCourseModel());
