...
class Auth1Model extends FlutterFlowModel<Auth1Widget> {
  ...
  // State field(s) for Sobrenome_Create widget.
  FocusNode? sobrenomeCreateFocusNode;
  TextEditingController? sobrenomeCreateTextController;
  String? Function(BuildContext, String?)?
      sobrenomeCreateTextControllerValidator;
  ...
  void dispose() {
    ...
    sobrenomeCreateFocusNode?.dispose();
    sobrenomeCreateTextController?.dispose();
