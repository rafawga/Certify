                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Align(
                                  alignment: const AlignmentDirectional(0.0, 0.0),
                                  child: Text(
                                    'Deixe alguma sugestão ou feedback para que possamos melhorar ainda mais a usa experiência!',
                                  ...
                                  child: RichText(
                                    ...
                                    text: TextSpan(
                                      children: [
                                        const TextSpan(
                                          text:
                                              'Reporte bugs ou informe feautures (funcionalidades)  que gostaria que o',
                                          style: TextStyle(),
                                        ),
                                        TextSpan(
                                          text: ' iDokey ',
                                              ...
                                              child: FFButtonWidget(
                                                onPressed: () async {
                                                  ...
                                                  ScaffoldMessenger.of(context)
                                                    ...
                                                    SnackBar(
                                                      content: Text(
                                                        'Seu feedback será analisado. Obrigado por contribuir!',
                                                        style: TextStyle(
                                                          color: FlutterFlowTheme
                                                                  .of(context)
                                                              .primaryText,
