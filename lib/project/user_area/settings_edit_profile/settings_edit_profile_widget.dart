                                                ...
                                                children: [
                                                  Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        'Área do usuário / Configurações / Editar Perfil',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .bodyMedium
                                            ...
                                            child: FFButtonWidget(
                                              onPressed: () async {
                                                await currentUserReference!
                                                  ...
                                                  displayName:
                                                      '${_model.yourNameController1.text} ${_model.yourNameController2.text}',
                                                  name: _model
                                                      .yourNameController1.text,
                                                  lastName: _model
                                                      .yourNameController2.text,
                                                  certificateName: _model
