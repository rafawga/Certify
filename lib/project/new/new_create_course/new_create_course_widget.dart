...
import 'new_create_course_model.dart';
export 'new_create_course_model.dart';

class NewCreateCourseWidget extends StatefulWidget {
  const NewCreateCourseWidget({super.key});

  @override
  State<NewCreateCourseWidget> createState() => _NewCreateCourseWidgetState();
}

class _NewCreateCourseWidgetState extends State<NewCreateCourseWidget>
    with TickerProviderStateMixin {
  late NewCreateCourseModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewCreateCourseModel());
    ...
    _model.limiteUsersTextController ??= TextEditingController();
                                                            ...
                                                            child:
                                                              ...
                                                              keyboardType:
                                                                  TextInputType
                                                                      .number,
                                                              validator: _model
                                                                  .limiteUsersTextControllerValidator
                                                                  .asValidator(
                                                                      context),
                                                              inputFormatters: [
                                                                FilteringTextInputFormatter
