...
import 'new_user_profile_model.dart';
export 'new_user_profile_model.dart';

class NewUserProfileWidget extends StatefulWidget {
  const NewUserProfileWidget({super.key});

  @override
  State<NewUserProfileWidget> createState() => _NewUserProfileWidgetState();
}

class _NewUserProfileWidgetState extends State<NewUserProfileWidget>
    with TickerProviderStateMixin {
  late NewUserProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewUserProfileModel());
                                                  ...
                                                  child: AuthUserStreamWidget(
                                                    builder: (context) =>
                                                      ...
                                                      decoration:
                                                          InputDecoration(
                                                        labelText:
                                                            'Nome de exibição para certificado',
                                                        labelStyle:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .labelMedium
