...
import 'new_user_courses_model.dart';
export 'new_user_courses_model.dart';

class NewUserCoursesWidget extends StatefulWidget {
  const NewUserCoursesWidget({super.key});

  @override
  State<NewUserCoursesWidget> createState() => _NewUserCoursesWidgetState();
}

class _NewUserCoursesWidgetState extends State<NewUserCoursesWidget>
    with TickerProviderStateMixin {
  late NewUserCoursesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewUserCoursesModel());
