...
/// Functions to query TemplateCertificadoRecords (as a Stream and as a Future).
Future<int> queryTemplateCertificadoRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
...
Stream<List<TemplateCertificadoRecord>> queryTemplateCertificadoRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<TemplateCertificadoRecord>> queryTemplateCertificadoRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
